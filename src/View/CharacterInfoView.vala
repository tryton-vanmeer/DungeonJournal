namespace DungeonJournal
{
    ...
    public class CharacterInfoView : Gtk.Bin
    {
        ...
        [GtkChild]private CharacterEntry race_character_entry;
        [GtkChild]private Gtk.ComboBoxText alignment_character_entry;
        [GtkChild]private CharacterEntryAdjustment level_character_entry;
        [GtkChild]private CharacterEntryAdjustment xp_character_entry;
